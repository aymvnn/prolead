-- ===========================================
-- PROLEAD - COMPLETE DATABASE SETUP
...
-- Org-scoped policies for all org-scoped tables
DO $$
DECLARE
  tbl TEXT;
BEGIN
...
-- Campaign-related table policies
...
-- =============================================
-- STAP 5: AUTOMATISCH ORG + USER BIJ SIGNUP
-- =============================================

-- Dit zorgt ervoor dat wanneer je je aanmeldt,
-- er automatisch een organisatie en gebruiker
-- worden aangemaakt. Zonder dit werkt login niet!
...
DECLARE
  new_org_id UUID;
BEGIN
  -- Maak automatisch een organisatie aan
  ...
  -- Maak de gebruiker aan met owner rol
...
-- =============================================
-- KLAAR! Je kunt nu de app starten en inloggen.
-- =============================================
